...
<body>
<p class="p1"><span class="s1"><b>// Kontrola kódu server.js a opravy</b></span></p>
...
<p class="p2"><span class="s1"><b></b></span><br></p>
<p class="p1"><span class="s1"><b>dotenv.config(); // Načítání proměnných z .env souboru</b></span></p>
...
<p class="p1"><span class="s1"><b>const DB_URI = process.env.MONGO_URI;</b></span></p>
...
<p class="p1"><span class="s1"><b><span class="Apple-converted-space">  </span>.catch(err =&gt; console.error('Database connection error:', err));</b></span></p>
<p class="p2"><span class="s1"><b></b></span><br></p>
<p class="p1"><span class="s1"><b>// User model</b></span></p>
<p class="p1"><span class="s1"><b>const UserSchema = new mongoose.Schema({</b></span></p>
<p class="p1"><span class="s1"><b><span class="Apple-converted-space">  </span>email: { type: String, required: true },</b></span></p>
<p class="p1"><span class="s1"><b><span class="Apple-converted-space">  </span>password: { type: String, required: true },</b></span></p>
...
<p class="p1"><span class="s1"><b><span class="Apple-converted-space">    </span>user: process.env.EMAIL_USER,</b></span></p>
<p class="p1"><span class="s1"><b><span class="Apple-converted-space">    </span>pass: process.env.EMAIL_PASS,</b></span></p>
...
<p class="p1"><span class="s1"><b><span class="Apple-converted-space">    </span>if (!email || !password) {</b></span></p>
<p class="p1"><span class="s1"><b><span class="Apple-converted-space">      </span>return res.status(400).json({ message: 'Email and password are required.' });</b></span></p>
<p class="p1"><span class="s1"><b><span class="Apple-converted-space">    </span>}</b></span></p>
...
<p class="p1"><span class="s1"><b><span class="Apple-converted-space">    </span>console.error('Error during registration:', error);</b></span></p>
<p class="p1"><span class="s1"><b><span class="Apple-converted-space">    </span>res.status(500).json({ message: 'Registration failed' });</b></span></p>
<p class="p1"><span class="s1"><b><span class="Apple-converted-space">  </span>}</b></span></p>
<p class="p1"><span class="s1"><b>});</b></span></p>
<p class="p2"><span class="s1"><b></b></span><br></p>
...
<p class="p1"><span class="s1"><b><span class="Apple-converted-space">    </span>const user = await User.findByIdAndUpdate(id, { verified: true });</b></span></p>
<p class="p1"><span class="s1"><b><span class="Apple-converted-space">    </span>if (!user) {</b></span></p>
<p class="p1"><span class="s1"><b><span class="Apple-converted-space">      </span>return res.status(404).send('User not found.');</b></span></p>
<p class="p1"><span class="s1"><b><span class="Apple-converted-space">    </span>}</b></span></p>
<p class="p1"><span class="s1"><b><span class="Apple-converted-space">    </span>res.send('Account verified!');</b></span></p>
<p class="p1"><span class="s1"><b><span class="Apple-converted-space">  </span>} catch (error) {</b></span></p>
<p class="p1"><span class="s1"><b><span class="Apple-converted-space">    </span>console.error('Error during verification:', error);</b></span></p>
<p class="p1"><span class="s1"><b><span class="Apple-converted-space">    </span>res.status(500).send('Verification failed.');</b></span></p>
<p class="p1"><span class="s1"><b><span class="Apple-converted-space">  </span>}</b></span></p>
<p class="p1"><span class="s1"><b>});</b></span></p>
<p class="p2"><span class="s1"><b></b></span><br></p>
